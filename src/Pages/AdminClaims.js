...
import { ReloadOutlined, SyncOutlined, CloseCircleOutlined, DeleteOutlined } from "@ant-design/icons";
                    ...
                    >
                      ...
                      <Descriptions.Item label="Date Found">
                        {details.foundItem?.dateFound
                          ? new Date(details.foundItem.dateFound).toLocaleDateString("en-US", {
                              month: "2-digit",
                              day: "2-digit",
                              year: "numeric",
                            })
